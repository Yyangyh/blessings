	...
	<view class="content">
		...
		<view class="box"  v-show="cur==0"> 
			<view class="line" v-for="(item,index) in dataList.one" :key='item.id'>
				...
				<view class="l-right">
					<view style="display: flex;"><text style="display:block;width: 240rpx;">昵称：{{item.nickname}}</text><text>{{item.mobile}}</text></view>
					<view><text>成为分销商时间：</text><text style="margin-right: 20rpx;">2019-05-38</text><text>16:03</text></view>
				</view>
			</view>
		</view>
		<!-- 二级 -->
